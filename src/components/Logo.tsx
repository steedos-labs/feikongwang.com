export function Logo(props: React.ComponentPropsWithoutRef<any>) {
  return (
    <div className="group flex flex-row justify-center items-center">
      <svg fill="#fff" className={`fill-sky-600 ${props.className}`} data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100">
      ...
      <div className="text-lg font-bold text-slate-900">费控王</div>
    </div>
  )
}
